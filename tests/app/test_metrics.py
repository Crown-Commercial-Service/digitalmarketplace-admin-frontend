...
from tests.app.helpers import BaseApplicationTest, LoggedInApplicationTest
...
class TestMetricsPage(BaseApplicationTest):
    ...
    def test_metrics_page_accessible(self):
        metrics_response = self.client.get('/admin/_metrics')
    ...
    def test_metrics_page_contents(self):
        ...
        assert (
            b'http_server_requests_total{code="200",host="localhost",method="GET",path="/admin/_metrics"}'
        ) in results


class TestMetricsPageRegistersPageViews(LoggedInApplicationTest):

    def test_metrics_page_registers_page_views(self):
        expected_metric_name = (
            b'http_server_requests_total{code="200",host="localhost",method="GET",path="/admin/users"}'
        )
    ...
    def test_metrics_page_registers_multiple_page_views(self):
        ...
        initial_metrics_response = self.client.get('/admin/_metrics')
