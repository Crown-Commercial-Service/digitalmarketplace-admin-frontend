...
class NewSellerUserForm(DmForm):
    new_name = StripWhitespaceStringField('Name', validators=[
        DataRequired(message="Name cannot be empty"),
    ])

    new_email_address = StripWhitespaceStringField('Email address', validators=[
        DataRequired(message="Email cannot be empty"),
        Email(message="Please enter a valid email address")
    ])

    new_phone = StripWhitespaceStringField('Phone', validators=[
